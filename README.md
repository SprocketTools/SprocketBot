...
This is the full version of Sprocket Bot containing all features developed for the bot.
## Invite the Scamsatsu scam-prevention bot [here!](https://discord.com/oauth2/authorize?client_id=1498533749124497478)
This is a lightweight clone of Sprocket Bot dedicated towards preventing and automatically removing scams.

## Important commands
`-help` - prints out a list of useful commands

`-settings` - allows the server staff to set up the bot
...
## Warnings
Sprocket bot is an **in-development** utility bot.  Its capabilities are changing continuously, and is nowhere near the end result I want it to be in.  As a result, 100% reliability in its services is not guaranteed.  
...
Everyone in the __**Zheifu Testing**__ server who has helped test the bot during development
